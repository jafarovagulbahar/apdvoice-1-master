(function ($)
{
    ...
    var TagSuggest = function (element, options)
    {
        ...
        this.addToSelection = function (items, isSilent)
        {
            ...
            cfg.onSelect(this.getSelectedItems());
        };
        ...
        this.removeFromSelection = function (items, isSilent)
        {
            ...
            cfg.onRemove(this.getSelectedItems());
        };
        ...
        {
            console.log('____________data________');
            console.log(data);
            console.log(cfg.valueField);
            console.log('____________data________');
            ...
            _processSuggestions: function (source) {
                ...
                if (data !== null) {
                    ...
                    if (typeof (data) === 'string' && data.indexOf(',') < 0) { // get results from ajax
                        ...
                        var params = {b: {'startLimit':'0','endLimit':'30'}};
                        var field = cfg.dataUrlParams.field;
                        params.b.includedFields = field;
                        params.b.distinctFields = field;
                        if(!ms.input.val().includes('click here'))
                        params.b[field] = '%%' + ms.input.val().toLowerCase() + '%%';
//                        var params = $.extend({query: ms.input.val()}, cfg.dataUrlParams);
                        ...
                        $.ajax({
                            ...
                            success: function (asyncData) {
                                var data= [];
                                var rows = asyncData.res.r;
                                for (var i in rows) {
                                    var value = rows[i][field];
                                    var obj = {id:i,name:value};
                                    if (value.length > 1) {
                                        data.push(obj);
                                    }
                                }
